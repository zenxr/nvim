...
vim.keymap.set('n', '<leader>sg', '<cmd>Telescope live_grep_args prompt_prefix=ripgrep> <cr>', { desc = '[S]earch [G]rep' })
...
vim.keymap.set('n', '<leader>dn', '<cmd>tabnew ' .. obsidian_daily_dir .. '/' .. new_daily_note() .. '<cr>', { desc = 'open [D]aily [N]ote' })
vim.keymap.set('n', '<leader>sc', '<cmd>Telescope live_grep cwd=' .. cheatsheets_dir .. ' prompt_prefix=cheatsheets> <cr>', { desc = '[S]earch [C]heatsheets' })
vim.keymap.set('n', '<leader>sn', '<cmd>Telescope live_grep cwd=' .. obsidian_dir .. ' prompt_prefix=notes> <cr>', { desc = '[S]earch [N]otes' })
vim.keymap.set(
  'n',
  '<leader>sd',
