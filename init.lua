...
-- <C-k> conflicts with digrams, and I'm undecided if those are worth keeping
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        -- in this case if ruff isn't found it will fall back to black
        ...
        menu = {
          draw = {
            columns = {
              ...
              { 'source_name' }, -- <- THIS is what you want
            },
            components = {
              source_name = {
                text = function(ctx)
